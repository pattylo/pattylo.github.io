...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/icuas_poland.jpg" title="The overall motivation and concept of LEDVO." class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/icuas_group.jpg" title="The overall motivation and concept of LEDVO." class="img-fluid rounded z-depth-1" %}
    </div>
</div>
